      ...
      <Link to={`/game/${game.id}`}>
        <div className="relative w-full pt-[56.25%]">
          ...
          {showVideo && videoId && !hasVideoError ? (
            ...
            <img
            src="https://eeikeheizmdybnufjqji.supabase.co/storage/v1/object/public/covers/recrec0ceryt4v4zktvr.webp"
            alt={game.Game_Title}
            ...
            onError={(e) => {
              ...
              target.src = "/path/to/local-fallback.jpg"; // Optional fallback
              }}
            />
          )}
