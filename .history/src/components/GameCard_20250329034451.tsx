...
import { getResponsiveImage, getImageSrcSet } from '../utils/imageHelpers';
      ...
      <Link to={`/game/${game.id}`}>
        <div className="relative w-full pt-[56.25%]">
          ...
          {showVideo && videoId && !hasVideoError ? (
            ...
            <img
              src={getResponsiveImage(game.id, 'medium')}
              srcSet={getImageSrcSet(game.id)}
              sizes="(max-width: 640px) 225px, (max-width: 10244px) 375px, 900px"
              alt={game.Game_Title}
              ...
              onError={(e) => {
                ...
                target.src = "/recrec0ceryt4v4zktvr.webp"; // Local fallback
                //target.src = getResponsiveImage(game.id, 'medium').replace('.webp', '_fback.jpg');
                //setHasVideoError(true);
              }}
            />
          )}
