...
export const GameCard: React.FC<GameCardProps> = ({ game }) => {
  ...
  // Calculate SRD price
  const srdPrice = exchangeRate ? (game.Price_to_Sell_For * exchangeRate).toFixed(2) : null;
  ...
  return (
    ...
    >
      ...
      {/* Add to Cart button with rounded price */}
      <button
        onClick={handleClick}
      ...
      {/* SRD price display */}
      {srdPrice && (
        <div className="absolute top-14 right-2 text-white z-20">
          <span
            className="text-sm font-semibold bg-gradient-to-r from-blue-400 via-blue-500 to-blue-400 bg-clip-text text-transparent"
          >
            SRD {srdPrice}
          </span>
        </div>
