      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 md:col-span-8">
          ...
          <div className="mb-6">
            ...
            {isEligible && (
              <Link to={`/flash-sale?platform=${game.Platform}`} className="inline-flex items-center mb-4 bg-gradient-to-r from-red-600 to-orange-500 text-white px-3 py-1 rounded-md hover:from-red-700 hover:to-orange-600 transition-colors">
