...
import { MessageCircle, CreditCard, ArrowLeft, Zap, Info, Truck, X, Sparkles } from 'lucide-react';

export const Checkout: React.FC = () => {
  const navigate = useNavigate();
  const { cart, removeFromCart, updateCartQuantity, getCartTotal, games } = useStore();
