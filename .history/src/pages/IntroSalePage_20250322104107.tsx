  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-white dark:bg-gray-900">
      ...
      <div className="mb-8 text-center">
        ...
        <details className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg mb-8">
  <summary className="font-semibold cursor-pointer">Read more about the Intro Sale</summary>
  <div className="mt-4 text-gray-700 dark:text-gray-300">
    <p>Bedankt dat u onze collectie checkt, wij hopen dat u ook uw collectie start. Daarvoor genieten alle Xbox One games momenteel een exclusieve kortingen tot 55%.</p>
    <ul className="list-disc pl-5 mt-2">
      <li>Bij aankoop van 1 - 5%</li>
      <li>Bij aankoop van 2 - 10%</li>
      <li>Bij aankoop van 3 - 15%</li>
      <li>Bij aankoop van 4 - 20%</li>
      <li>Bij aankoop van 5 - 25%</li>
      <li>Bij aankoop van 6 - 30%</li>
      <li>Bij aankoop van 7 - 35%</li>
      <li>Bij aankoop van 8 - 40%</li>
      <li>Bij aankoop van 9 - 45%</li>
      <li>Bij aankoop van 10 - 50%</li>
      <li>Bij aankoop van 11 - 55% op alle 11 games <span role="img" aria-label="heart">❤️</span></li>
    </ul>
  </div>
</details>
      </div>
