    ...
    (set, get) => ({
      ...
      addToCart: (game) =>
        set((state) => {
          ...
          // Debugging: Check if the game is eligible for Intro Sale
          const isIntroEligible = isIntroSaleEligible(game);
          console.log(`Game: ${game.Game_Title}, isIntroSaleEligible: ${isIntroEligible}`);
