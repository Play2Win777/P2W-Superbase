                                    ...
                                    <div className="sl-preview-heading" style={{ position: 'absolute', inset: '0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(40, 37, 54, 0.9)', zIndex: '999999', fontFamily: 'Poppins, Arial, sans-serif', fontSize: 'clamp(20px, 2.664vw, 28px)', fontWeight: '500', lineHeight: 'normal', textAlign: 'center', borderRadius: '10px' }}>
                                        ...
                                        <button onClick={(e) => {
                                            if (typeof Storylane !== 'undefined') {
                                                Storylane.Play({ type: 'preview_embed', demo_type: 'image', width: 1920, height: 959, element: e.target, demo_url: 'https://app.storylane.io/demo/gc4nsbbb2ugi?embed=inline_overlay' })
                                            } else {
                                                console.error("Storylane is not defined. Ensure the script is loaded.");
                                            }
                                        }} className="sl-preview-cta" style={{ backgroundColor: '#9939EB', border: 'none', borderRadius: '8px', boxShadow: '0px 0px 15px rgba(26, 19, 72, 0.45)', color: '#FFFFFF', display: 'inline-block', fontFamily: 'Poppins, Arial, sans-serif', fontSize: 'clamp(16px, 1.599vw, 20px)', fontWeight: '600', height: 'clamp(40px, 3.996vw, 50px)', lineHeight: '1.2', padding: '0 clamp(15px, 1.776vw, 20px)', textOverflow: 'ellipsis', transform: 'translateZ(0)', transition: 'background 0.4s', whiteSpace: 'nowrap', width: 'auto', zIndex: '999999', cursor: 'pointer' }}>VIEW DEMO</button>
                                    </div>
