...
// Create a separate search component that has access to navigation
const SearchBar = () => {
  const { 
    games, 
    searchGames, 
  ...
  const handleSearch = (e) => {
    ...
    // If you have a searchGames function in your store, use it
    if (searchGames) {
      searchGames(term);
    } else {
      // Otherwise implement basic search logic here
      if (!term.trim()) {
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <h1 
                  ...
                  className="text-2xl font-bold text-gray-900 dark:text-white whitespace-nowrap cursor-pointer"
                >
                  Play 2 Win
                </h1>
                <button
