                ...
                >
                  <div className="flex justify-between mb-2">
                    <div className="flex items-center gap-4">
                      {/* Clickable image */}
                      <picture>
                      <source srcSet={getGameCoverUrl(item.id)} type="image/webp" />
                        <img 
                          src={getGameCoverFallbackUrl(item.id)}
                          alt={item.Game_Title}
                          className="w-20 h-30 object-cover rounded cursor-pointer hover:opacity-80 transition-opacity"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {recommendedGames.map((game) => (
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white -mt-7">
                      {game.Game_Title}
                    </h3>
