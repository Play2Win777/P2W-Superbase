...
import { MessageCircle, CreditCard, ArrowLeft, Zap, Info, Truck, X } from 'lucide-react';
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md sticky top-8">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="border-t dark:border-gray-700 pt-3 mt-3">
                ...
                {(flashSaleDiscount > 0 || volumeDiscount > 0) && (
                  <div className="text-green-600 text-sm text-right mt-1">
                    You saved: ${(flashSaleDiscount + volumeDiscount).toFixed(2)}
                  </div>
                )}
              </div>
            </div>
