...
export const GameDetails: React.FC = () => {
  ...
  // Filter suggestion games: same platform & genre while excluding the current game
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 md:col-span-4">
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="px-3 py-1 bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-100 rounded-full">
              {game.Platform}
            </span>
